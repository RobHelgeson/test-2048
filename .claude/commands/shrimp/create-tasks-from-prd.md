...
3. When all epics are created, use Shrimp to map dependencies between the start nodes of epics and the completion nodes of other epics
   - If you are uncertain about the dependencies of the epics on each other, ask the user to define them.
4. Discover the stories for each epic and create Shrimp tasks for each.
